...
type ShippingOptionWithFulfillment = HttpTypes.StoreCartShippingOption & {
  service_zone?: {
    fulfillment_set?: {
      type?: string
...
function getFulfillmentSet(option: HttpTypes.StoreCartShippingOption) {
  return (option as ShippingOptionWithFulfillment).service_zone?.fulfillment_set
}
...
const Shipping: React.FC<ShippingProps> = ({
  ...
  const _shippingMethods = availableShippingMethods?.filter(
    (sm) => getFulfillmentSet(sm)?.type !== "pickup",
  )
                          ...
                          <div className="flex items-start gap-x-4">
                            ...
                            <div className="flex flex-col">
                              ...
                              <span className="text-base-regular text-ui-fg-muted">
                                {formatAddress(
                                  getFulfillmentSet(option)?.location
